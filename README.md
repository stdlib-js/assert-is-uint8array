...
```javascript
import isUint8Array from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint8array@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-uint8array/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/assert-is-uint8array/actions/workflows/test.yml?query=branch:v0.2.3
